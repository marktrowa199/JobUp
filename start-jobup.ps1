...
Write-Host "Starting JobUp developer stack..."

Start-Process powershell -ArgumentList @(
    "-NoProfile",
    "-NoExit",
    "-Command",
    "cd '$frontendDir'; & '$nodeExe' .\node_modules\next\dist\bin\next dev -H 127.0.0.1 -p 3000"
...
Start-Process powershell -ArgumentList @(
    ...
    "-NoExit",
    "-Command",
    "cd '$backendDir'; `$env:PYTHONPATH = '$backendDir'; & '$pythonExe' -m uvicorn app.main:app --host 127.0.0.1 --port 8000"
